...
Key.prototype = {
    ...
    _getKey: function () {
        ...
        button.width = primary_monitor.width/12 * this._key.width;
        button.height = primary_monitor.height/14.5;
    ...
    _getExtendedKeys: function () {
        ...
        for (let i = 0; i < this._extended_keys.length; i++) {
            ...
            let primary_monitor = global.get_primary_monitor();
            key.width = primary_monitor.width/12 * this._key.width;
            key.height = primary_monitor.height/14.5;
